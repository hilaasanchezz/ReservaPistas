        ...
        <div class="cajaHorarios">
            ...
            <div class="fechaSelector">
                ...
                <div class="contenedor-desplegable">
                    <form id="formCalendario" action="horarioFut.php" method="POST">
                        <!-- Tiene cargada la fecha actual en el atributo value. El min bloquea las fechas anteriores a hoy
                        ...
                        <input type="date" id="inputCalendarioHidden" name="fecha_actual" value="<?php echo $fecha_reserva; ?>" min="<?php echo $fecha_hoy; ?>" onchange="document.getElementById('formCalendario').submit();">
                    </form>
